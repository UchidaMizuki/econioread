...
`io_table_reader()` builds a step-by-step reader for a single input-output
table file. Each step is applied in turn, transforming the raw cells of
the file into a finished `econio` input-output table:
